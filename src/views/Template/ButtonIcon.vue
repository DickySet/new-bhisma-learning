            ...
            <div class="padding-content">
                <div class="d-flex flex-wrap" style="gap: 20px">
                    <div style="width: 49.5%; flex-grow: 1; flex-basis: 48%">
                        <div class="mt-2">
                            ...
                            <div class="d-flex" style="gap: 10px">
                                ...
                                <button class="button-tutup">Tutup</button>
                            </div>
                        </div>
                        <div class="mt-4">
                            <label style="font-weight: bold">Button With Icon</label>
                    ...
                    <div style="width: 49.5%; flex-grow: 1; flex-basis: 48%">
                        <div class="mt-2 ">
                            ...
                            <div class="d-flex justify-content-between flex-wrap" style="gap: 10px">
                                <div class="d-flex" style="gap: 10px">
                                    ...
                                    <div class="icon-tambah" v-popover="'File Word'">
                                ...
                                <div class="d-flex" style="gap: 10px">
                                    ...
                                    <div class="icon" v-popover="'Cari Data'">
                        ...
                        <div class="mt-4 ">
                            <label style="font-weight: bold">Icon Table</label>
    ...
    <div class="card border-0 mt-3">
        <div class="card-body">
            <div class="padding-content">
                ...
                <div class="d-flex justify-content-center flex-wrap" style="gap: 40px">
                    <div class="d-flex align-items-center" style="gap: 15px">
                        <div style="border-radius: 50%; width: 70px; height: 70px; background-image: linear-gradient(to bottom, #2ccf7e 0%, #067c7e 100%);"></div>
                        <div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #2ccf7e;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#2ccf7e</label>
                            </div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #067c7e;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#067c7e</label>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center" style="gap: 15px">
                        <div style="border-radius: 50%; width: 70px; height: 70px; background-image: linear-gradient(to bottom, #489DEC 0%, #00387F 100%);;"></div>
                        <div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #489DEC;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#489DEC</label>
                            </div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #00387F;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#00387F</label>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center" style="gap: 15px">
                        <div style="border-radius: 50%; width: 70px; height: 70px; background-image: linear-gradient(to bottom, #EE427D 0%, #A8144A 100%);"></div>
                        <div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #EE427D;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#EE427D</label>
                            </div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #A8144A;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#A8144A</label>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center" style="gap: 15px">
                        <div style="border-radius: 50%; width: 70px; height: 70px; background-image: linear-gradient(to bottom, #3C3C43 0%, #1E1E1F 100%);"></div>
                        <div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #3C3C43;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#3C3C43</label>
                            </div>
                            <div class="d-flex align-items-center mb-1" style="gap: 10px">
                                <div style="border-radius: 50%; width: 35px; height: 35px; background-color: #1E1E1F;"></div>
                                <label style="font-weight: bold; margin-top: 6px">#1E1E1F</label>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                title: 'Button and Icon',
                subTitle: 'Menampilkan design button dan Icon yang digunakan'
            }
        }
    }
